    ...
    try {
      ...
      if (sensorStatus.gps.available) {
        try {
          ...
          setSensorStatus(prev => ({
            ...prev,
            gps: { ...prev.gps, permission: 'denied', error: error as any }
          }));
        }
      }
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ 
            ...
            <span style={{ fontSize: '20px', marginRight: '12px' }}>
              {getStatusIcon(sensorStatus.orientation.permission, sensorStatus.orientation.available)}
            </span>
            <div style={{ flex: 1 }}>
            ...
            <span style={{ fontSize: '12px', color: '#888' }}>
              {getStatusText(sensorStatus.orientation.permission, sensorStatus.orientation.available)}
            </span>
          </div>

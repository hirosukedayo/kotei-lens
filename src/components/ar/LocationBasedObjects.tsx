...
import {
  ...
  getLocationColor,
  getLocationPriority,
} from '../../data/historical-locations';
import {
  ...
  return (
    <group>
      {visibleObjects.map((obj) => (
        <LocationMarker key={obj.id} object={obj} />
      ))}
    </group>
  );
}

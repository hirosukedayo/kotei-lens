...
// 指定された中心座標
// 地形の中心点（3D座標: [-7760.5, 1845.8, 7760.5]）に対応するGPS座標
// これにより、地形の中心点が3D座標の[0, 0, 0]に対応する
// 古いSCENE_CENTER (35.779417, 139.024694) を基準に計算
export const SCENE_CENTER: GPSCoordinate = {
  latitude: 35.63983329354536, // 地形の中心点に対応
  longitude: 138.85271442134245, // 地形の中心点に対応
  altitude: 0, // 標高は0を基準とする（地形の高さ1845.8mは3D座標のy座標で表現）
};

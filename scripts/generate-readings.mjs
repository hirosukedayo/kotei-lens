...
- 奥多摩・小河内村周辺の地名は以下の読みを使うこと:
  留浦=とずら、小留浦=ことずら、峰=みね、川野=かわの、青木=おおき、麦山=むぎやま、
  南=みなみ、河内=こうち、湯場=ゆば、原=はら、熱海=あたみ、日指=ひさし、
  岫沢=くきさわ、出野=いでの、水根=みずね、坂本=さかもと、小河内=おごうち、
  峰谷=みねだに、箭芎=やきゅう、金御岳=きんみたけ、老梅=ろうばい、熱海向=あたみむこう、
  女の湯=めのゆ、琴橋=ことばし、菅渡橋=すがわたりばし、頭領=とうりょう、
  小菅遠江守=こすげとおとうみのかみ、馬渡橋=またどばし、馬渡戸橋=またどばし

## フォーマットルール
- \\n は削除し、文として自然につなげる
- 〔〕内の人名・年齢・出身情報は保持する。ただし人名はフルネームではなく苗字+「さん」のみにする（例: 〔田中太郎さん（67）峰谷〕→ たなかさん、67歳、みねだに出身）
- 「」内の会話はそのまま残す
